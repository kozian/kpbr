...
### Скачиваем образы
1. Скачать официальный образ-посредник [WR3000P V1.zip](https://drive.google.com/file/d/1_Om5G9Audep1TfSTSwmB4j7FLI6ZVYqa/view?usp=drive_link) (или [отсюда](https://www.cudy.com/ru-by/blogs/faq/openwrt-%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%BD%D0%BE%D0%B5-%D0%BE%D0%B1%D0%B5%D1%81%D0%BF%D0%B5%D1%87%D0%B5%D0%BD%D0%B8%D0%B5-%D0%B7%D0%B0%D0%B3%D1%80%D1%83%D0%B7%D0%BA%D0%B0) переходим по ссылку на google disk и качаем прошивку для WR3000P. Распаковываем. На момент написания файл назывался `cudy_wr3000p-v1-sysupgrade_20251119.bin`.
2. Скачать [Cudy WR3000P](https://firmware-selector.openwrt.org/?version=25.12.2&target=mediatek%2Ffilogic&id=cudy_wr3000p-v1) прошивку openWRT, вариант `Sysupgrade`. На момент написания `openwrt-25.12.2-mediatek-filogic-cudy_wr3000p-v1-squashfs-sysupgrade.bin`
Прямая ссылка - https://downloads.openwrt.org/releases/25.12.2/targets/mediatek/filogic/openwrt-25.12.2-mediatek-filogic-cudy_wr3000p-v1-squashfs-sysupgrade.bin

### Обновляем прошивку на посредника
3. Подключаемся к роутеру по проводу, заходим на http://192.168.10.1/ 
    - Вводим пароль
...
5. В нижней опции загрузки `Firmware` выбираем и загружаем первый скаченный образ `cudy_wr3000p-v1-sysupgrade_20251119.bin`
...
9. В нижнем меню "Установить новый образ прошивки" загружаем второй скаченный образ `openwrt-25.12.2-mediatek-filogic-cudy_wr3000p-v1-squashfs-sysupgrade.bin`
    - Галочку "сохранить настройки" лучше снять, так как мы ничего не настраивали. 
...
TBD: добавить работу с sing-box и поддержку vless